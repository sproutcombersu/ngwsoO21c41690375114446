...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string APP_NAME = "Slots-Casino Game App";
        private static string COMPANY_NAME = "169037574982042784334";
        private static string BUILD_VERSION_NAME = "1.0.0";
        private static string PACKAGENAME = "com.fastappmobile.slotscasinogameapp";
        private static string PATH_KEYSTORE = "data.keystore";
        private static string KEYSTORE_PASS = "232345";
        private static string KEY_ALIAS_NAME = "Fast App Mobile";
